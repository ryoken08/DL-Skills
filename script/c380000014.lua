...
function s.flipcon(e,tp,eg,ep,ev,re,r,rp)
	...
	and Duel.IsExistingMatchingCard(Card.IsLevelAbove,tp,LOCATION_DECK,0,1,nil,5)
	and s[2+tp]>=1000
end
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(Card.IsLevelAbove,tp,LOCATION_DECK,0,nil,5):RandomSelect(tp,1)
	local tc=g:GetFirst()
	if tc then
