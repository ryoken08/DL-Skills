...
function s.spfilter(c,lv,att)
	return c:IsLevel(lv) and c:IsRace(RACE_DINOSAUR) and c:IsAttribute(att) and c:IsSummonableCard()
end
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg=Duel.GetMatchingGroup(s.spfilter,tp,LOCATION_DECK,0,nil,g1:GetLevel()+3,g1:GetAttribute()):RandomSelect(tp,1)
