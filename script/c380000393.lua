...
s.listed_names={4357063}
s.listed_series={0x70,0x48}
function s.exfilter(c)
	return c:IsMonster() and not (c:IsSetCard(0x70) or c:IsSetCard(0x48))
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetLabel()==0 then
		...
		--begin Duel with Chronomaly City Babylon activated
		local token=Duel.CreateToken(tp,4357063)   
