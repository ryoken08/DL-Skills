--Return from Another Dimensions
local s,id=GetID()
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	--Place 1 face-down "Return from the Different Dimension" from outside of your Deck
	local token=Duel.CreateToken(tp,27174286)
